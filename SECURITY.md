...
- **Email**: security@ionic.io
- **GitHub Security Advisory**: [Report a vulnerability](https://github.com/JWEB0689/ionicons/security/advisories/new)
...
Icon font and SVG components
No runtime dependencies
CSP-compatible (no inline scripts)
Tree-shakeable ES modules
Framework-agnostic (React, Vue, Angular, HTML)

## Audit History

| Date | Version | Type | Description |
|------|---------|------|-------------|
| 2026-06-26 | current | Code review | Icon library reviewed for supply chain security |
